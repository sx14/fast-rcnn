...
vg_obj_hyper_params = {
    ...
    'log_path': os.path.join(global_config.project_root, log_root, 'vg_obj_loss.txt'),
    'log_loss_path': os.path.join(global_config.project_root, log_root, 'vg_obj_loss.bin'),
    'log_acc_path': os.path.join(global_config.project_root, log_root, 'vg_obj_acc.bin'),
...
vg_pre_hyper_params = {
    ...
    'lr': 0.1,
    'log_root': os.path.join(global_config.project_root, log_root),
    'log_path': os.path.join(global_config.project_root, log_root, 'vg_pre_loss.txt'),
    'log_loss_path': os.path.join(global_config.project_root, log_root, 'vg_pre_loss.bin'),
    'log_acc_path': os.path.join(global_config.project_root, log_root, 'vg_pre_acc.bin'),
