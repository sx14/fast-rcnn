...
def extract_fc7_features(net, img_box_label, img_root, list_path, feature_root, label_list_path, label2index):
    ...
    for i in range(0, len(image_list)):
        ...
        for box_id in range(0, len(curr_img_boxes)):
            ...
            label_list.append(feature_id+' '+str(box_id)+' '+str(vg_label_index)+'\n')
...
if __name__ == '__main__':
    ...
    if target == 'object':
        ...
        label_save_root = vrd_data_config.vrd_object_label_root_t
    else:
        label2index_path = ''
        vg2wn_path = ''
        feature_root = ''
    ...
    for d in datasets:
        ...
        extract_fc7_features(net, box_label, img_root, anno_list, fc7_save_root, label_save_path, label2index)
