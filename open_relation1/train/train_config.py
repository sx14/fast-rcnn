...
vrd_obj_hyper_params = {
    ...
    'print_freq': 10,
    'lr': 0.01,
    'log_root': os.path.join(global_config.project_root, log_root+'_obj'),
    'log_path': os.path.join(global_config.project_root, log_root+'_obj', 'vrd_loss.txt'),
    'log_loss_path': os.path.join(global_config.project_root, log_root+'_obj', 'vrd_loss.bin'),
    'log_acc_path': os.path.join(global_config.project_root, log_root+'_obj', 'vrd_acc.bin'),
...
vrd_pre_hyper_params = {
    ...
    'print_freq': 10,
    'lr': 0.01,
    'log_root': os.path.join(global_config.project_root, log_root+'_pre'),
    'log_path': os.path.join(global_config.project_root, log_root+'_pre', 'vrd_loss.txt'),
    'log_loss_path': os.path.join(global_config.project_root, log_root+'_pre', 'vrd_loss.bin'),
    'log_acc_path': os.path.join(global_config.project_root, log_root+'_pre', 'vrd_acc.bin'),
