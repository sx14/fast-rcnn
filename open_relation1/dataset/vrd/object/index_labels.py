...
def index_labels1(objnet, raw2wn, label2index_path, index2label_path):
...
if __name__ == '__main__':
    ...
    label2index = index_labels1(objnet, raw2wn, obj_label2index_path, obj_label_list_path)

    vrd2path_path = vrd_object_config['vrd2path_path']
    vrd2pw_path = vrd_object_config['vrd2pw_path']
    vrd2path(raw2wn, label2index, vrd2path_path, vrd2pw_path)
