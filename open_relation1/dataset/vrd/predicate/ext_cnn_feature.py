...
if __name__ == '__main__':
    ...
    if target == 'predicate':
        ...
        fc7_save_root = vrd_data_config.vrd_predicate_fc7_root
        label_save_root = vrd_data_config.vrd_predicate_label_root
    ...
    for d in datasets:
        ...
        vrd2path = pickle.load(open(raw2path_path, 'rb'))
        ...
        extract_fc7_features(net, box_label, img_root, anno_list, fc7_save_root,
                             label_save_path, label2index, vrd2path, sample_ratio)
