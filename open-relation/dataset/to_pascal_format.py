...
def output_pascal_format(mid_data, output_path):
    ...
    des_depth = des_xml_dom.createTextNode(mid_data['depth'])
    ...
    for j in range(0, len(org_objects)):
        ...
        # truncated
        des_truncated = des_xml_dom.createTextNode(org_object['truncated'])
        ...
        # difficult
        des_object_difficult = des_xml_dom.createTextNode(org_object['difficult'])
